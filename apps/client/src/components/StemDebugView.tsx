...
export function StemDebugView() {
  ...
  const myAssignedStem = currentDeviceIndex >= 0 ? getAssignedStem(currentDeviceIndex) : null;
        ...
        <div className="bg-neutral-800/50 rounded-md p-3 space-y-2">
          ...
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ backgroundColor: myAssignedStem.color }}
            />
            <span className="font-medium">{myAssignedStem.name}</span>
            {isPlaying && (
              <motion.div
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          {STEMS.map((stem) => {
            ...
            const isMyCurrentStem = myAssignedStem?.id === stem.id;
